...
// Excluded from the production bundle by build.mjs. The picker reads from
// UBE_HUES (palette.jsx) and reuses TweakRow (tweaks-panel.jsx) for layout.
...
Object.assign(window, { UbeHuePicker })
