  ...
  return (
    <TweakRow label={label}>
      <div ref={trackRef} role="radiogroup" onPointerDown={onPointerDown}
        ...
        {opts.map((o) => (
          // biome-ignore lint/a11y/useSemanticElements: dev-only tweaks panel uses styled <button>s in a radiogroup; converting to <input type="radio"> would require restyling
