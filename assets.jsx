...
const SparkIcon = ({ size = 20 }) => (
  <Glyph
    size={size}
    paths=<path d="M12 3v4M12 17v4M3 12h4M17 12h4M5.6 5.6l2.8 2.8M15.6 15.6l2.8 2.8M5.6 18.4l2.8-2.8M15.6 8.4l2.8-2.8" />
  />
)
...
const StarIcon = ({ size = 20 }) => (
  <Glyph
    size={size}
    paths=<path d="M12 3l2.7 5.7 6.3.9-4.6 4.4 1.1 6.2L12 17.3 6.5 20.2l1.1-6.2L3 9.6l6.3-.9L12 3Z" />
  />
)
...
const WrenchIcon = ({ size = 16 }) => (
  <Glyph
    size={size}
    paths=<path d="M21 7a4 4 0 0 1-5 5l-7 7-3-3 7-7a4 4 0 0 1 5-5l-2 3 2 2 3-2Z" />
  />
)
