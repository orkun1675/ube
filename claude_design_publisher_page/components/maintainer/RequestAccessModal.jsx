/* RequestAccessModal.jsx — the conversion modal. The Maintainer-vs-
   Publisher radio is the demand signal the whole site exists to gather. */

const RequestAccessModal = ({ open, source, onClose }) => {
  const [interest, setInterest] = React.useState("maintainer");
        ...
        {!submitted ? (
          <React.Fragment>
            ...
            <p className="t-body-sm body" style={{ margin: 0, marginBottom: 22 }}>
              We'll be in touch as soon as your repo is in scope. <span className="mono" style={{ color: "var(--muted)" }}>source: {source || "—"}</span>
            </p>
          ...
          <div style={{ textAlign: "center", padding: "24px 8px" }}>
            ...
            <p className="t-body-sm body" style={{ margin: 0 }}>
              We'll reach out once Ube is ready for your repo.
            </p>
          </div>
        )}
      </div>
